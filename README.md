...
이메일 주소도 자동 링크로 만들 수 있으며, 이러한 규칙을 따릅니다.

> 1. ' @ '문자 앞부분은 영어, 숫자, ., -, \_, + 로 구성됩니다.  
> 
> 2. ' @ ' 문자는 반드시 들어가야합니다.
> 
> 3. ' @ '문자 뒷부분은 영어, 숫자, ., -, \_ 로 구성됩니다.   
> 
> 4. ' @ '문자 뒷부분에는 마침표(.)가 적어도 한 개는 들어가야 합니다.
> 
> 5. 이메일의 마지막 문자는 - 문자나 _ 문자가 아니어야 합니다.

</br>

    abc_123+hi@gmail.com
